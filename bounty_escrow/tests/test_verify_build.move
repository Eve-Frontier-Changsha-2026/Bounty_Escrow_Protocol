...
// Generated by: node scripts/gen_test_vectors.mjs build 0xfa873fa0...c6b1 0x784696db...28ec
...
const BUILD_MSG: vector<u8> = x"";
const BUILD_SIG: vector<u8> = x"95996cc85941bde7b8e6702cb3c9b277424f43cccab902a558b4b68bb557a8e4bc489c247915a8a4b0d10935117960d47154e24042469f3e4df2b0d73bea550d";

// Wrong bounty_id
const BUILD_WRONG_BOUNTY_MSG: vector<u8> = x"";
const BUILD_WRONG_BOUNTY_SIG: vector<u8> = x"9dbadbb6be8e44cada1dee3d8f5851f206d2698f72bf4e29499a1bda0941889624ed7431b9d6e9a5050fe3716bec8a655ad16afca5afeee17a8dae0cf0717403";

// Wrong hunter
const BUILD_WRONG_HUNTER_MSG: vector<u8> = x"";
const BUILD_WRONG_HUNTER_SIG: vector<u8> = x"21e1f32c60d4ad344241ae7ac91410636a56c6422559d3a7a6a9baa977747fd2e99e72ea6385b48f62fd7e0aae1987c83469432e763f78ff801e111ec6933f0f";
...
const BUILD_WRONG_TYPE_MSG: vector<u8> = x"";
const BUILD_WRONG_TYPE_SIG: vector<u8> = x"9d3cb4bc51a80fe74a932cc9f13cc05811eca3bb7b46ee5fe090f7f9466d3f3f1ce6ead180e2b46bf28400574aa433da2229a69cdba48b91d6b1dfdf4b232609";

// Solar system mismatch (att=99, criteria=42)
const BUILD_WRONG_SOLAR_MSG: vector<u8> = x"";
const BUILD_WRONG_SOLAR_SIG: vector<u8> = x"558f265cc324bfcb1f84a340fe620ad447ebb5879556f85c0bd2632232156df9c179a2f263713317bac9f53197f7bd0937d59869e2d4214e99c012a688e3b00f";

// Nonce replay (nonce=1 again, different timestamp)
const BUILD_REPLAY_MSG: vector<u8> = x"";
const BUILD_REPLAY_SIG: vector<u8> = x"167dec97f1f2eb35a707f15b0e4600577b18817204e059ab6ea31a5c40416fcd3adc5c724b3aa772f59f73b2dfc67fd3cd5b20a73e1f22108d2ff5f699cb5b00";
...
fun test_verify_build_encrypted_criteria_blocked() {
    let mut scenario = ts::begin(CREATOR);
    let mut clock = clock::create_for_testing(ts::ctx(&mut scenario));
    let (char_id, assembly_id) = full_world_setup(&mut scenario, &mut clock);
    setup_bounty(&mut scenario, &clock);
